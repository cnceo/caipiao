...
<!--侧导航 -->
					...
					<ul class="tree_one" style="display:block">
						...
						<div class="m_nav_line"></div>
							<dl>
								...
								<dd>
									<ul class="lot_list">
										<li><a href="/index.php/index/game/1/6/重庆彩">重庆彩<i>H</i></a> </li>
	...
	<style>
		...
		.foo{  background-size: 100% 2.933333rem;
    position: fixed;
    width: 100%;
   bottom: 0;
    z-index: 100;
		...
		.menufoo { position: fixed; width: 100%; bottom: 0; left: 0; right: 0; z-index: 6; /*transform: translate3d(0, 0, 0);*/ margin:auto; background: #171719 }
.menufoo ul { margin:auto; overflow: hidden; background: #171719; }
.menufoo ul li { width: 33%;
    float: left;
    text-align: center;}
.menufoo a img { max-width: 100%; height: 49px; }
		
		</style>	
<div class="foo">
  <div class="menufoo" id="fixnav">
    <ul>
        <li><a class="menu-home" href="/"><img src="/skin/main/img/nav_1.png"></a></li>
        <li><a class="menu-color" href="/index.php/index/draw"><img src="/skin/main/img/nav_2.png"></a></li>
      
        <li><a class="menu-my" href="/index.php/safe/Personal"><img src="/skin/main/img/nav_5.png"></a></li>
    </ul>
