...
<body class="login-bg">
        ...
        <div class="head">
            <div class="headerTop">
                <div class="toolbar-left">
                      <button id="reveal-left" onclick="history.go(-1)"></button>
                </div>
	...
	<div class="menu">
	     <ul>
	         ...
	         <li>
	             <a class="menu-lot" href="/index.php/index/draw"><img src="assets/statics/images/nav_03.png"></a>
	         </li>
	         <li>
    ...
    <script type="text/javascript">
	    requirejs(["jquery", "layer", "common"], function($,layer) {
	        ...
	        function getDrawList(dayType) {
	        	...
	        	$.ajax({
		            url: '/index.php/index/getDrawLists',
		            type: 'POST',
		            dataType: 'json',
		            data: {
		                'gameId': $('#gameId').val(),
