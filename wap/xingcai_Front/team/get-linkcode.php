<div>
	...
	?>
        ...
        <tr>
			...
			<td><input class="t-c t-c-w1" style="width:310px" id="biao1" readonly="readonly" value="http://m.fcyl168.com/index.php/user/r/<?=$this->strToHex($this->myxor($linkData['lid']));?>" /></td>
        </tr>
		...
		<tr>
			...
			<td><input class="t-c t-c-w1" style="width:310px" id="biao2" readonly="readonly" value="http://m.fcyl168.com/index.php/user/_api/<?=$this->strToHex($this->myxor($linkData['lid']));?>" /></td>
        </tr>
