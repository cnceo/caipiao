...
<div class="row">
            ...
            ?>
                                    ...
                                    <td><a href="/index.php/record/betInfo/<?=$var['id']?>" width="80%" title="投注信息" button="关闭:defaultModalCloase"   modal="true" button="确定:dataAddCode|取消:defaultCloseModal"><?=$var['wjorderId']?></td>
