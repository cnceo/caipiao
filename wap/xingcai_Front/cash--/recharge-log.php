...
<body class="login-bg">
	 <div class="header">
        <div class="headerTop">
            ...
            <div class="bett-top-box">    
                <div class="bett-tit"><span id="status_type">全部</span><i class="bett-attr"></i></div>              
            </div>
        </h1>
    ...
    <div class="beet-tips" hidden="">
        ...
        <ul>
            ...
            <li><a href="javascript:;" data-type="0">待审核</a></li>
            <li><a href="javascript:;" data-type="1">已存入</a></li>
        </ul>
    </div>
    
    <script src="/assets/js/require.js" data-main="/assets/js/application/depositLog"></script>
