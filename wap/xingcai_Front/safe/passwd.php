...
<body class="login-bg">
    <div class="header">
	    <div class="headerTop">
	        ...
	        <h1 class="ui-toolbar-title"><?php if($args[0]){ ?>
	        			修改资金密码
						<?php }else{?>
						设置资金密码
						<?php }?>
	        ...
	        <div class="login">
	            <ul>
	                <li>
	                    ...
	                    <span class="logi">旧提款密码</span><input type="password" id="trans_pwd_old" maxlength="6" name="pwd" value="123456">
	                </li>
	                <li>
	...
	<?php }else{?>
	    ...
	    <div class="sub_ScorllCont">
	        <div class="login">
	            ...
	            <button class="login-btn" id="login-btn">确定</button>
	        </div>
	    </div>
	</div>
	<?php }?>
