...
<body>
    <div id="root">
    	<div data-reactroot="" style="background-color: rgb(245, 245, 249); height: 100vh;">
    		<div class="header">
			    <div class="headerTop">
			        <div class="ui-toolbar-left">
			            <button id="reveal-left" onclick="history.go(-1);">reveal</button>
			        </div>
			        <h1 class="ui-toolbar-title">关于我们</h1>
			    </div>
			</div>
			<div style="height: 44px;" class="ipad-top"></div>
			
			<div style="text-indent: 2rem; margin: 20px;">	彩38（8c38.com）是一家专注于网络彩票投注和服务的互联网, 作为国内领先的互联网彩票公司,公司始终坚持走“易用、安全、便捷”的道路， 让每个彩民享受到安全、快捷的购彩服务。依托网络、通信和数字电视技术， 通过网络、电话、手机短信、数字电视、电子杂志、电子邮件和平面媒体等多样化服务手段， 为广大彩民提供全国各大联销型彩票及各地地方彩票的代购合买、彩票资讯、 彩票分析彩票软件、彩票社区等全方位、一体化的综合彩票服务，深受广大彩民的欢迎。</div>
		</div>
	</div>
</body>
</html>