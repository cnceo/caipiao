...
<body class="login-bg">
	<div class="header">
	    <div class="headerTop">
	        ...
	        <h1 class="ui-toolbar-title">代理中心</h1>
	...
	<div id="wrapper_1" class="scorllmain-content top_bar bottom_bar">
	    <div class="sub_ScorllCont">
	        <div class="mine-top">
	            ...
	            <div class="mine-info">
	                <ul>
	                    ...
	                    <li>
	                        <a href="/index.php/safe/Personal" style="color: rgb(255, 255, 255);line-height: 45px;"><i class="icon-iphone-icon"></i> 会员中心</a>
	                    </li>
            ...
            <div class="mine-but" style="padding-top: 15px;">
		            <a href="http://m.fcyl168.com/index.php/cash/recharge" class="recharge"><img src="/assets/statics/images/geren_cz_01.png"></a>
	        ...
	        <div class="mine-list">
	            <ul>
	                ...
	                <li>
	                    <a href="/index.php/team/addlink">
	                        <img src="/assets/statics/images/geren_tubiao_06.png" alt="">推广设定
	                    </a>
	                </li>
	                <li>
	                    <a href="/index.php/team/addMember">
	                        <img src="/assets/statics/images/geren_tubiao_13.png" alt="">开户管理
	                    </a>
	                </li>
	                <li>
	                    <a href="/index.php/team/memberList">
	                        <img src="/assets/statics/images/geren_tubiao_24.png" alt="">会员列表
	                    </a>
	                </li>
	                <li>
	                    <a href="/index.php/team/linkList">
	                        <img src="/assets/statics/images/geren_tubiao_26.png" alt="">推广链接
	                    </a>
	                </li>
	                <li>
	                    <a href="/index.php/team/gameRecord">
	                        <img src="/assets/statics/images/geren_tubiao_04.png" alt="">团队记录
	                    </a>
	                </li>
	                <li>
	                    <a href="/index.php/team/report">
	                        <img src="/assets/statics/images/geren_tubiao_13.png" alt="">团队盈亏
	                    </a>
	                </li>
	               
	                <li>
	                    <a href="/index.php/team/cashRecord">
	                        <img src="/assets/statics/images/geren_tubiao_06.png" alt="">团队提现<span id="count_unread"></span> <i class="red-icon" id="flag_unread" style="display:none;"></i>
	                    </a>
	                </li> 
	                <li>
	                    <a href="/index.php/team/coinall">
	                        <img src="/assets/statics/images/geren_tubiao_30.png" alt="">团队统计
	                    </a>
	                </li>
	            </ul>
	        </div>
		       ...
		       // getUnReadCount();
		        ...
		        $('#withdraw_set').on('click', function() {
		        	/* if($('#is_question_set').val() == 0) {
		        		...
		        		location.href = 'http://m.fcyl168.com/index.php/cash/withdraw'
		        	/* } */
		        });
