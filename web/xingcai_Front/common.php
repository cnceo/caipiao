...
<style>
    /*file_path :   cai99\templates\default\login\lobby_common.php */
    .live-logo {cursor:pointer;
    ...
    #i_list_2  iframe{background-color: #F8F6F6;}
</style>
...
$(function(){
    ...
    <script>
        ...
        function goIframe()
        {
            ...
            if( url.indexOf("/index/lobby.html") >= 0 || url.indexOf("%2Findex%2Flobby.html") >= 0 )
            {//够彩大厅主页
            ...
            {//不是够彩大厅主页
                ...
                {//如果从未加载过当前url的iframe
                    ...
                    }catch(e){console.log(e);flag = false;}
                    if( flag === false )
                    {
                        $("#__iframe_list_  .div_iframe,#_tip_loading_").css("display","none");
                        $("#i_list_2").css("display","block");
        ...
        function fresh_all_lottery()
        {
            ...
            {
                try{ __openWin('lottery_hall','/index.php/index/hall/'); }catch(e){}
...
<!--           <li class="nav-li lot9" data-sort="3">
         ...
         <!--  <li class="nav-li lot18" data-sort="6">
           ...
           <li class="nav-li lot3f" data-sort="7">
            <a id="hot_main-item-5" class="nav-btn cur-btn" data-argsid="5" title="香港三分彩" onclick="__openWin('lottery_hall','/index.php/index/game/86/香港三分彩')">
              <i>
              </i>
              <span class="lot-text">香港三分彩</span></a>
          </li>
        </ul>
      </div>
        ...
        <ul class="gao-ul">
          <li id="shishicai_ul">
            ...
            <ul hidden="">
			  ...
			  <li class="nav-li lot9" data-sort="3">
                <a id="main-item-9" class="nav-btn cur-btn" data-argsid="9" title="三分PK拾" onclick="__openWin('lottery_hall','/index.php/index/game/85/27/三分PK拾')">
                  <i>
                  </i>
            ...
            <a id="hot_main-item-5" class="nav-btn cur-btn" data-argsid="5" title="香港三分彩" onclick="__openWin('lottery_hall','/index.php/index/game/86/香港三分彩')">
              ...
              <li class="nav-li lot42" data-sort="5">
                <a id="main-item-52" class="nav-btn cur-btn" data-argsid="52" title="腾讯分分彩" onclick="__openWin('lottery_hall','/index.php/index/game/5/腾讯分分彩')">
                  <i>
                  </i>
                  <span class="lot-text">腾讯分分彩</span></a>
              </li>
			  <li class="nav-li lot5" data-sort="5">
                <a id="main-item-52" class="nav-btn cur-btn" data-argsid="52" title="澳门五分彩" onclick="__openWin('lottery_hall','/index.php/index/game/14/河内5分彩')">
                  <i>
                  </i>
                  <span class="lot-text">澳门五分彩</span></a>
              </li>
			  ...
			  <li class="nav-li lot28" data-sort="100">
                <a id="main-item-7" class="nav-btn cur-btn" data-argsid="7" title="幸运28" onclick="__openWin('lottery_hall','/index.php/index/game/80/幸运28')">
                  <i>
                  </i>
                  <span class="lot-text">幸运28</span></a>
              </li>
               <li class="nav-li lot18" data-sort="100">
                <a id="main-item-7" class="nav-btn cur-btn" data-argsid="7" title="高速六合彩" onclick="__openWin('lottery_hall','/index.php/index/game/77/高速六合彩')">
                  <i>
                  </i>
                  <span class="lot-text">高速六合彩</span></a>
              </li>
            </ul>
          </li>
          <li id="kuaisan_ul">
            ...
            <div id="_lottery_menu_head" class="new-header">
                <div name="hide">
                    ...
                    <div id="header_user" class="header-user" >
						...
						<div class="user-center" ><ul><li onclick="__openWin('user_center','/index.php/record/search')"><a><i class="icon-3"></i>下注记录</a></li><li onclick="zxkf('<?= $this->settings['kefuGG']?>');"><a><i class="icon-4"></i>在线客服</a></li><li onclick="__openWin('user_center','/index.php/box/receive')"><a><i class="icon-Shape-47"></i>消息中心</a></li></ul></div>
                    </div>
