	...
	<body>
		<div class="header-plus" id="header_plus">
				...
				<div class="quick-tpis">
					...
					<div class="header-right fr">
						...
						<ul class="header-top-right fr ">
							...
							<li><a id="agent_reg_url" class="right-border" href="http://daili.fcyl168.com" target="_blank" >代理登陆</a></li>
			...
			<div class="liansai-wrap" id="liansai-wrap" >
				<div class="liansai" id="liansai" style="width: 1000px; margin: 0 auto;">
					<div class="wrapper clearfix relative" style="width: 100%;">
						...
						<div id="header_user" class="logxinxi" hidden="" style="display: block;">
							<div class="top_login">
								...
								<span>&nbsp;|&nbsp;
                                   <a onclick="__openWin('user_center','/index.php/box/receive')" href="javascript:void(0)">用户中心</a>&nbsp;|&nbsp;
                                    <a onclick="__openWin('user_center','/index.php/cash/recharge2')" href="javascript:void(0)">充值</a>&nbsp;|&nbsp;
                                    <a onclick="topay();">提现</a>&nbsp;|&nbsp;
                                    <a onclick="__openWin('user_center','/index.php/record/search')" href="javascript:void(0)" >交易记录</a>&nbsp;|&nbsp;
...
<div class="lotterys-list-hd" id="lotterysList" style="display:block">
  <ul class="lottery-list-box" id="lottery-list-box">
    ...
    <li class="mainGame">
      <a onclick="__openWin('lottery_hall','/index.php/index/game/77/高速六合彩');" class="mainA">
        <i class="icon nav40-9">
          <img src="/files/52.png"></i>
      </a>
      <div class="fl">
        <a onclick="__openWin('lottery_hall','/index.php/index/game/77/高速六合彩');" class="mainA">
          <span class="color333">高速六合彩</span>
          <p>
            <span class="normal-desc"></span>
          </p>
        </a>
