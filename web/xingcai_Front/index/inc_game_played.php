...
?>
<!--div class="game-btn2" style="margin-top:-10px"-->
<div class="game-btn2" style="margin-top:-5px">
	<?php
...
<?php if($this->type==34 || $this->type==77)
{$yc="none";}
else{$yc="block";};
?>

<div id="game-helptips" class="game-helps" style="display:<?php echo $yc ?>"><?php $this->display("index/inc_game_tips.php", 0 ,$this->played); ?></div>
