            ...
            <div class="reg-info" id="reg_form_1">
                <ul>
                    ...
                    <li>
                     ...
                     <li>
                        <div class="info-left"><span class="red">* </span>QQ：</div>
                        <div class="info-right"><input name="qq" id="qq"  class="reg-int" type="text"  maxlength="12"></div>
                        <div class="info-txt"></div>
                    </li>
                    <li>
                        <div class="info-left"><span class="red">* </span>验证码：</div>
                    ...
                    <li>
                        <div class="info-left">&nbsp;</div>
                        <div class="info-right"><input type="checkbox" name="reg_checkbox" checked="checked"/>我已看过并同意<a class="orange" target="_self" onClick="" width="1000" height="653" border="0">《688网络服务协议》</a></div>
                    </li>
                    <li>
                        <div class="info-left">&nbsp;</div>
