...
<div class="lotterys-list-hd" id="lotterysList" style="display:block">
  <ul class="lottery-list-box" id="lottery-list-box">
    <li class="mainGame">
      ...
      <div class="fl">
        <a onclick="__openWin('lottery_hall','/index.php/index/game/86/2/12/香港三分彩');" class="mainA">
    ...
    <li class="allGames clearfix" data-type="1">
      ...
      <ul class="clearfix game-list">
        <li>
          <a onclick="__openWin('lottery_hall','/index.php/index/game/86/2/12/三分时时彩');">香港三分彩</a></li>
        <li>
					...
					<div class="wrapper">
						...
						?>	   
										...
										<ul class="user-help-box help-ul" id="cont_help_newer" style="display: none;">
											<li><a onclick="__openWin('user_center','/index.php/notice/view/115')">如何注册成为688会员？</a></li>
...
<div class="jc-footer">
    ...
    <div class="foot_box">
        <div class="about_box">
            <p>2009-2017©<span>福彩168 | </span> 客服邮箱：cai1688vip@gmail.com<!-- 客服QQ：201716002 | 流量统计 -->
...
<div id="_rightAD" class="_float_AD r_AD " >
    <img src="./files/online-right.png">
    <div name="close_btn"></div>
	...
	$('.header-top-center').hover(function() {
		...
		var s = "";
			if($(this).attr("data-gameid")==5){//重庆时时彩快速投注
					$("span[name=issue]").text("20170710144");
