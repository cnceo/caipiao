<div class="jc-footer">
    ...
    <div class="foot_box">
        <div class="about_box">
            <p>2009-2017?<span>福彩168 | </span> 客服邮箱：cai688@vip.qq.com<!-- 客服QQ：201716002 | 流量统计 -->
...
$("#lotterys").mouseover(function (e) {
    $("#lotterysList").show();
})
$("#lotterys").mouseout(function (e) {
    $("#lotterysList").hide();
})
...
/*                  var unslider04 = $('#b04').unslider({
        ...
        $(" [name=quick_tab_list]>li").bind('mouseover',function(e){
            ...
            $("[name=change_gameNum]").bind("click",function(){
...
<script language="javascript" src="/files/index.js.下载"></script>
