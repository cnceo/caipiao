<div>
<form action="/index.php/time/added" method="post" target="ajax" onajax="sysBeforeUpdateTime" call="sysUpdateTime" dataType="html">
	...
	<table cellpadding="2" cellspacing="2" class="popupModal">
        ...
        <tr>
         ...
         <tr>
			...
			<td><input type="text" name="actionTime"  value=""/> 如：2017-05-11 21:30:00</td>
		</tr>
	</table>
</form>
</div>
