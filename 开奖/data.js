						...
						if(err){
							...
							if(tag){
								submitData(data, conf);
									...
									if(data.type=='14' || data.type=='26' || data.type=='61' || data.type=='62' || data.type=='63' || data.type=='64' || data.type=='65' || data.type=='66' || data.type=='67'  || data.type=='68' || data.type=='69' || data.type=='70' || data.type=='71' || data.type=='72' || data.type=='73'||  data.type=='74' || data.type=='75' || data.type=='76' || data.type=='77' || data.type=='78' || data.type=='85' || data.type=='86'|| data.type=='87'){
										liRunData(data, conf);
									}else{
										submitData(data, conf);
									}
