...
// 时时彩龙虎和中奖函数 qq1226642
//龙 
exports.ssc_lhh_l=function(betData, kjData){
kjData=kjData.split(',');betData=betData.split(' ');
var qq1226642 = 0;
for(var i=0;i<betData.length;i++){
	if(betData[i] =='万千' && kjData[0]>kjData[1])  qq1226642+=1;
	if(betData[i] =='万百' && kjData[0]>kjData[2])  qq1226642+=1;
	if(betData[i] =='万十' && kjData[0]>kjData[3])  qq1226642+=1;
	if(betData[i] =='万个' && kjData[0]>kjData[4])  qq1226642+=1;
	if(betData[i] =='千百' && kjData[1]>kjData[2])  qq1226642+=1;
	if(betData[i] =='千十' && kjData[1]>kjData[3])  qq1226642+=1;
	if(betData[i] =='千个' && kjData[1]>kjData[4])  qq1226642+=1;
	if(betData[i] =='百十' && kjData[2]>kjData[3])  qq1226642+=1;
	if(betData[i] =='百个' && kjData[2]>kjData[4])  qq1226642+=1;
	if(betData[i] =='十个' && kjData[3]>kjData[4])  qq1226642+=1;
 }
 return qq1226642;
...
for(var i=0;i<betData.length;i++){
	if(betData[i] =='单' && sum%2!=0)  qq1226642+=1;
	if(betData[i] =='双' && sum%2==0)  qq1226642+=1;
	if(betData[i] =='大' && sum<10 && sum>4)  qq1226642+=1;
	if(betData[i] =='小' && sum<10 && sum<5)  qq1226642+=1;
 	if(betData[i] =='大' && sum>9 && sum%10>4)  qq1226642+=1;
	if(betData[i] =='小' && sum>9 && sum%10<5)  qq1226642+=1; 
 }
	return qq1226642;
}
//// 牛牛玩法中奖函数 qq1226642
...
/* exports.niuniu=function(betData, kjData){
	var qq245649162 = 0;betData=betData.split(' ');kjData=kjData.split(',');
...
exports.niuniufalse=function(betData, kjData){
 ...
 if(qq245649162>0) qq245649162=0;
 else qq245649162=1;
 return qq245649162;
}
//// 牛牛大小单双玩法中奖函数 qq1226642
exports.niuniudxds=function(betData, kjData){
	var qq1226642 = 0;betData=betData.split('');kj=kjData.split(',');
	var cn = ['牛','一','二','三','四','五','六','七','八','九','牛'];
	if((parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10))%10 ==0 ){
		var a =parseInt(kj[3])+parseInt(kj[4]);if(a>9) a=a-10;
		if(a%2==0 && betData.indexOf('双')!=-1) qq1226642+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq1226642+=1;
		if(a>4 && betData.indexOf('大')!=-1) qq1226642+=1;
		if(a<5 && betData.indexOf('小')!=-1) qq1226642+=1;
	 }
	if((parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[3],10))%10 ==0 ){
		var a =parseInt(kj[2])+parseInt(kj[4]);if(a>9) a=a-10;
		if(a%2==0 && betData.indexOf('双')!=-1) qq1226642+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq1226642+=1;
		if(a>4 && betData.indexOf('大')!=-1) qq1226642+=1;
		if(a<5 && betData.indexOf('小')!=-1) qq1226642+=1;
	...
	if((parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[4],10))%10 ==0 ){
		var a =parseInt(kj[2])+parseInt(kj[3]);if(a>9) a=a-10;
		if(a%2==0 && betData.indexOf('双')!=-1) qq1226642+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq1226642+=1;
		if(a>4 && betData.indexOf('大')!=-1) qq1226642+=1;
		if(a<5 && betData.indexOf('小')!=-1) qq1226642+=1;
	...
	if((parseInt(kj[0],10)+parseInt(kj[2],10)+parseInt(kj[3],10))%10 ==0 ){
		var a =parseInt(kj[1])+parseInt(kj[4]);if(a>9) a=a-10;
		if(a%2==0 && betData.indexOf('双')!=-1) qq1226642+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq1226642+=1;
		if(a>4 && betData.indexOf('大')!=-1) qq1226642+=1;
		if(a<5 && betData.indexOf('小')!=-1) qq1226642+=1;
	...
	if((parseInt(kj[0],10)+parseInt(kj[2],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[1])+parseInt(kj[3]);if(a>9) a=a-10;
		if(a%2==0 && betData.indexOf('双')!=-1) qq1226642+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq1226642+=1;
		if(a>4 && betData.indexOf('大')!=-1) qq1226642+=1;
		if(a<5 && betData.indexOf('小')!=-1) qq1226642+=1;
	...
	if((parseInt(kj[0],10)+parseInt(kj[3],10)+parseInt(kj[4],10))%10 ==0 ){
		var a =parseInt(kj[1])+parseInt(kj[2]);if(a>9) a=a-10;
		if(a%2==0 && betData.indexOf('双')!=-1) qq1226642+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq1226642+=1;
		if(a>4 && betData.indexOf('大')!=-1) qq1226642+=1;
		if(a<5 && betData.indexOf('小')!=-1) qq1226642+=1;
	...
	if((parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[4]);if(a>9) a=a-10;
		if(a%2==0 && betData.indexOf('双')!=-1) qq1226642+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq1226642+=1;
		if(a>4 && betData.indexOf('大')!=-1) qq1226642+=1;
		if(a<5 && betData.indexOf('小')!=-1) qq1226642+=1;
	...
	if((parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[3]);if(a>9) a=a-10;
		if(a%2==0 && betData.indexOf('双')!=-1) qq1226642+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq1226642+=1;
		if(a>4 && betData.indexOf('大')!=-1) qq1226642+=1;
		if(a<5 && betData.indexOf('小')!=-1) qq1226642+=1;
	...
	if((parseInt(kj[1],10)+parseInt(kj[3],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[2]);if(a>9) a=a-10;
		if(a%2==0 && betData.indexOf('双')!=-1) qq1226642+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq1226642+=1;
		if(a>4 && betData.indexOf('大')!=-1) qq1226642+=1;
		if(a<5 && betData.indexOf('小')!=-1) qq1226642+=1;
	...
	if((parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[1]);if(a>9) a=a-10;
		if(a%2==0 && betData.indexOf('双')!=-1) qq1226642+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq1226642+=1;
		if(a>4 && betData.indexOf('大')!=-1) qq1226642+=1;
		if(a<5 && betData.indexOf('小')!=-1) qq1226642+=1;
